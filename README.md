...
Build Node.js command-line application that takes in information about employees on a software engineering team, then generates an HTML webpage that displays summaries for each person.

Testing is key to making code maintainable, so write a unit test for every part of our code and ensure that it passes each test.
...
And the directory structure looks like the following flow:
...
The 'Employee' parent class has properties and methods:
